...
with strategy.scope():
    ...
    rgb = residual_block_4d(rgb,4) #4D residual block
    ...
    opt = residual_block_4d(opt,4) #4D residual block
...
class MyCbk(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        self.model_to_save.save('Logs_FGN_8_4D/model_at_epoch_%d.h5' % (epoch+1))

check_point = MyCbk(model)


filename = 'Logs_FGN_8_4D/ours_log.csv'
